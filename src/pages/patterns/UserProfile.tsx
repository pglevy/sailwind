      ...
      <div className="p-6 min-h-screen max-w-6xl mx-auto">
          ...
          >
            ...
            <RichTextDisplayField
              ...
              value={[
                <TextItem
                  key="1"
                  text="Building A, Floor 3, Office 312"
                  style="STRONG"
                />,
              ]}
              marginBelow="STANDARD"
        ...
        >
          ...
          <div className="space-y-4">
            <div className="flex gap-4 border-b border-gray-200">
              <StampField backgroundColor="ACCENT" icon="file-text" contentColor="STANDARD" size='SMALL' />
              <div className="flex-1">
                <RichTextDisplayField
                  value={[
            ...
            <div className="flex gap-4 border-b border-gray-200">
              <StampField backgroundColor="POSITIVE" icon="check-circle" contentColor="STANDARD" size='SMALL' />
              <div className="flex-1">
                <RichTextDisplayField
                  value={[
            ...
            <div className="flex gap-4">
              <StampField backgroundColor="#7F44B3" icon="users" contentColor="STANDARD" size='SMALL' />
              <div className="flex-1">
                <RichTextDisplayField
                  value={[
        ...
        <CardLayout shape="SEMI_ROUNDED" padding="STANDARD" showBorder={true}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <CardLayout>
              <RichTextDisplayField
                value={[<Icon key="1" icon="award" size="MEDIUM" color="#7F44B3" />]}
                align="CENTER"
                marginBelow="LESS"
              />
              <RichTextDisplayField
                value={[
                  <TextItem
                    key="1"
                    text="Product Management Certificate"
                    style="STRONG"
                    size="SMALL"
                  />,
                ]}
