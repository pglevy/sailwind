...
- [x] 1. Install Storybook and configure the project
  - [x] 1.1 Install Storybook v10 dependencies
  ...
  - [x] 1.2 Create `.storybook/main.ts` configuration
  ...
  - [x] 1.3 Create `.storybook/preview.tsx` configuration
    - Import `../src/index.css` for Tailwind and Aurora theme styles
    - Configure controls matchers and a11y settings
    - _Requirements: 1.6, 1.7_

- [x] 2. Create component stories (batch 1: display components)
  - [x] 2.1 Create Heading stories
...
- [x] 3. Create component stories (batch 2: interactive components)
  - [x] 3.1 Create Button stories
    ...
    - _Requirements: 2.1, 2.2, 2.3, 2.4, 4.1, 4.4_
  - [x] 3.2 Create TextField stories
...
- [x] 6. Create page and pattern stories
  ...
  - [x] 6.6 Create pattern stories for DocumentReview, Publications, ApplicationStatus
...
- [x] 7. Checkpoint - Verify all stories
...
- [x] 8. Remove deprecated custom app scaffolding
  - [x] 8.1 Remove demo files and custom routing files
